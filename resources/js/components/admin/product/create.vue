        ...
        <section class="content"   >
         ...
         <div class="row"  style="padding: 10px;">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input @input="toSeoUrl()" type="text" class="form-control"
                                            ...
                                            <div  style="margin-left: 8px;" class="col-sm-2">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <input   :class="{ 'is-invalid': form.errors.has('product_price') }"  @click="folderCheck"  type="number" class="form-control"  v-model="form.product_price"
...
<div class="first" v-for="first in categories" :key="first.category_id">
   ...
   <br>
                                            ...
                                            <td>  <img    :src="form.photo" alt="" width="80" height="50"></td>
                                            </tr>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                form: new Form({
                    ...
                    status: 1,
                    status: 1,
                    delivery_in_dhaka: 60,
                    delivery_out_dhaka: 120,
                    sku: "",
                    category_id:[],
                    photo: '',
                    photo_true:false,
        ...
        methods:{
            ...
            folderCheck(){
              ...
              axios.get("/api/folderCheck").then(response=>{

                        this.form.folder=response.data.folder;
...
c
 ...
 var vm = this;
            ...
            store() {
             ...
             toSeoUrl() {
              this.form.product_name =this.form.product_title;
                this.form.product_name= this.form.product_name.toString()               // Convert to string
